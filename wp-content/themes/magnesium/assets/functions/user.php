 ...
 * Time: 12:19
 */
define('JOINTS_USER_AVATAR', true);
define('JOINTS_USER_AVATAR_PREFIX', 'joints_');
...
class basic_user_avatars {
	...
	public function __construct() {
		...
		add_shortcode( 'basic-user-avatars-update',     array( $this, 'shortcode_update'                )        );
	...
	public function edit_user_profile( $profileuser ) {
        ...
        <script type="text/javascript">
            var form = document.getElementById('your-profile');form.encoding = 'multipart/form-data';
	...
	function shortcode() {
		...
		return get_avatar( $profileuser->ID, 250 );
	}
