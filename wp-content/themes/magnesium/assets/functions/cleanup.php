...
function joints_excerpt_more($more) {
	...
	//return '<div class="read-more__container"><a class="excerpt-read-more" href="'. get_permalink($post->ID) . '" title="'. __('Read', 'jointswp') . get_the_title($post->ID).'">'. $label[$lang] .'</a></div>';
