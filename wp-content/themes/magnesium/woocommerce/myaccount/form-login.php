...
if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) {
    ?>
    <div class="columns large-6 login__column">
    <?php
} else {
    ?>
    <div class="columns login__column">
    <?php
}
?>
...
if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) {
    ?>
    </div><!-- .columns.login__column -->

    <div class="columns large-6 register__column">
        <h2><?php _e( 'Register', 'woocommerce' ); ?></h2>

        <form id="register-form" method="post" class="register">
             ...
             *
             * @hooked joints_woo_avatar_field - 10
             */
