...
<div id="reviews" class="woocommerce-Reviews">
	<div id="comments">
		<?php if ( have_comments() ) : ?>
            <div class="slider__container slider-arrows-right">
                <div class="slider__inner">
                    <div class="slide-header">
                        <h3 class="woocommerce-Reviews-title text-center"><?php _e( 'Reviews', 'woocommerce' ); ?></h3>
                    </div>
                    ...
                    <div class="commentlist">
		                <?php wp_list_comments( apply_filters( 'woocommerce_product_review_list_args',
			                array(
				                ...
				                'end-callback'      => 'joints_woo_comments',
				                'per_page'          => 0,
